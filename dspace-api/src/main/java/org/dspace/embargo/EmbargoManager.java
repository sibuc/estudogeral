...
public class EmbargoManager
{
    ...
    public static final String EMBARGO = ConfigurationManager.getProperty("embargo.rights.text");
    /** log4j category */
        ...
        throws SQLException, AuthorizeException, IOException
    {
        ...
        try
        {
            ...
            log.info("Embargo setter " + setter.getClass().getCanonicalName());
            setter.setEmbargo(context, item);
            
                      // ALS
          // alteracao para continuar com dc.rights a definir o periodo de embargo no formulario 
          // mas fazer a atualizacao de acordo com as novas regras
         
           String dc_rights=item.getMetadata(ConfigurationManager.getProperty("embargo.field.terms"));
           log.info("INSTALL ITEM -- dc.rights:" + dc_rights);
           if (dc_rights!=null) {
                log.info("INSTALL ITEM -- dc.rights (valor):" + dc_rights);
                if (dc_rights.startsWith("embargo")) {
                   item.clearMetadata(terms_schema, terms_element, terms_qualifier, Item.ANY);
                   item.addMetadata(terms_schema, terms_element, terms_qualifier, null, EmbargoManager.EMBARGO);
                }
           }
          // Fim ALS
    ...
    private static void init()
    {
        if (terms_schema == null)
        {
            ...
            // als - alteracao decorrente da nova definicao de metadados
            String terms = ConfigurationManager.getProperty("embargo.field.terms");
    ...
    public static String getSchemaOf(String field)
    {
    ...
    public static String getElementOf(String field)
    {
        String sa[] = field.split("\\.", 3);
    ...
    public static String getQualifierOf(String field)
    {
        String sa[] = field.split("\\.", 3);
