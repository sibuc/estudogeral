         ...
         throws PluginInstantiationException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                if (cacheMe(module, pluginClass))
                {
                    log.info("cacheMe(module, pluginClass)==" + module + " " + pluginClass.getName());
                    ...
                    if (cached == null)
                    {
                        log.debug("Creating cached instance of: " + cname +
                                          " for interface=" + iname +
                                          " pluginName=" + name );
                        log.info("Creating cached instance of: " + cname +
                                          " for interface=" + iname +
                                          " pluginName=" + name );
                        cached = pluginClass.newInstance();
                ...
                else
                {
                        log.debug("Creating UNcached instance of: " + cname +
                                  " for interface=" + iname +
                                  " pluginName=" + name );
                        log.info("Creating UNcached instance of: " + cname +
                                  " for interface=" + iname +
                                  " pluginName=" + name );
