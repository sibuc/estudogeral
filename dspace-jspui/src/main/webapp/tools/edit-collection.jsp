...
<%
    ...
    if (collection != null)
    {
        ...
        embargo = collection.getMetadata("embargo");
        datafinal = collection.getMetadata("inicioprazodeposito");
...
<%-- ===========================================================
     ...
     <div class="panel panel-primary">
     	...
     	<div class="panel-body">
           ...
           <div class="row">
            	<label class="col-md-3" for="embargo_description"><fmt:message key="jsp.tools.edit-collection.form.label28"/></label>
                <span class="col-md-9">
                	<textarea class="form-control" name="embargo_description" rows="6" cols="50"><%= Utils.addEntities(embargo) %></textarea>
                </span>
            </div><br/>
            <div class="row">
            	<label class="col-md-3" for="datafinal_description"><fmt:message key="jsp.tools.edit-collection.form.label29"/></label>
                <span class="col-md-9">
                	<textarea class="form-control" name="datafinal_description" rows="6" cols="50"><%= Utils.addEntities(datafinal) %></textarea>
                </span>
            </div><br/>
<%-- ===========================================================
     Logo
