...
%>
       ...
       <div class="navbar-header">
         <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
           ...
           <a class="navbar-brand" href="<%= request.getContextPath() %>/"><img height="25" src="<%= request.getContextPath() %>/image/logo3.png" alt="UC logo" /></a>
         <a class="navbar-brand" href="http://worldheritage.uc.pt"><img style="margin-right:30px" height="25" src="<%= request.getContextPath() %>/image/unesco.png" alt="unesco logo" /></a>
       </div>
       <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
         <ul class="nav navbar-nav">
          ...
          <li class="<%= ( currentPage.contains( "/help" ) ? "active" : "" ) %>"><dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.site-admin\") %>"><fmt:message key="jsp.layout.navbar-admin.help"/></dspace:popup></li>
       </ul>
