...
<%
    ...
    if (epersonForm != null)
    {
        ...
        preferred_handles = epersonForm.form_getPreferredHandle();
        if (preferred_handles == null) preferred_handles = "";
    }
%>
    ...
    <div class="form-group">
           <%-- <td>PreferredHandles:</td> --%>
            <label class="col-md-offset-3 col-md-2 control-label" for="tpreferreg_handles"><fmt:message key="jsp.dspace-admin.eperson-edit.preferredhandles"/></label>
            <div class="col-md-3">
               <input class="form-control" type="text" name="preferred_handles" id="tpreferred_handles" size="24" value="<%=preferred_handles == null ? "" : Utils.addEntities(preferred_handles) %>"/>
           </div> 
    </div>
     <div class="form-group">
