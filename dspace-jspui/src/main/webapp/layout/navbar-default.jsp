...
<%
    ...
    EPerson user = (EPerson) request.getAttribute("dspace.current.user");
     ...
     Boolean b_academicos = (Boolean)request.getAttribute("academicos");
     boolean academicos = (b_academicos == null ? false : b_academicos.booleanValue());
 ...
 %>
    ...
    <div class="nav navbar-nav navbar-right">
     ...
     <%
		...
		if (current_lang.equals("pt_PT")) {current_lang = "PT";}
		if (current_lang.equals("en")) {current_lang = "EN";}
		
	 %>

      <li class="dropdown">
       <a href="#" class="dropdown-toggle" data-toggle="dropdown"><%=current_lang%><b class="caret"></b></a>
    ...
    for (int i = supportedLocales.length-1; i >= 0; i--)
     {
		...
		if (supportedLocales[i].toString().equals("pt_PT")) {lang = "PT";}
		if (supportedLocales[i].toString().equals("en")) {lang = "EN";}
		
		if (lang.equals(current_lang)) {continue;}
 %>
      <li>
...
<%= lang %>
 ...
 %>
    ...
    {
		%>
		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="/image/lock.png" alt="login" height=""></span> <fmt:message key="jsp.layout.navbar-default.loggedin">
		...
		%>
             ...
             <!--<span class="glyphicon glyphicon-user"></span> <fmt:message key="jsp.layout.navbar-default.sign"/><img src="/image/lock.png" alt="login" height="">--> 
	<% } %>             
             <ul class="dropdown-menu">
               ...
               %>  
              <li class="divider"></li>  
               <li><a href="<%= request.getContextPath() %>/criaprovas"><fmt:message key="jsp.layout.navbar-admin.cria-col-provas"/></a></li>
