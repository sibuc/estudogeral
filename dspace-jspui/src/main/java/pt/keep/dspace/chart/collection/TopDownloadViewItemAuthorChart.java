...
public class TopDownloadViewItemAuthorChart extends AbstractCollectionChart {
	...
	public List<Data> getDownloadedData (Collection c) throws SQLException {
		String query;
			...
			"WHERE " +
				"(d.item_id IN (SELECT tmp.item_id FROM collection2item tmp WHERE tmp.collection_id IN ("+c.getID()+"))) AND " +
	...
	public List<Data> getItemData (Collection c) throws SQLException {
		String query;
	...
	public String chartID() {
		return "topviewdownitemauthorcoll";
	}
