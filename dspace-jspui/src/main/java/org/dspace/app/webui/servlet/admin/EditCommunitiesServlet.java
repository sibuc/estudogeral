...
public class EditCommunitiesServlet extends DSpaceServlet
{
            ...
            AuthorizeException
    {
        ...
        String embargo = request.getParameter("embargo_description");

        if (embargo.equals(""))
        {
            embargo = null;
        }
        String inicioprazodeposito = request.getParameter("datafinal_description");

        if (inicioprazodeposito.equals(""))
        {
            inicioprazodeposito = null;
        }
        ...
        collection.setMetadata("embargo", embargo);
        collection.setMetadata("inicioprazodeposito", inicioprazodeposito);
