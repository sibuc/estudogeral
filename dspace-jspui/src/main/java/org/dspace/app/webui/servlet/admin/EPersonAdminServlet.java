...
public class EPersonAdminServlet extends DSpaceServlet
{
            ...
            SQLException, AuthorizeException
    {
        ...
        else if (button.equals("submit_save") || button.equals("submit_resetpassword"))
        {
            ...
            // String oldPrefHandles = e.getPreferredHandle();
            // String newPrefHandles = request.getParameter("preferred_handles");
            ...
            if (!newEmail.equals(oldEmail))
            {
                ...
                if (EPerson.findByEmail(context, newEmail) == null)
                {
                    ...
                    e.setPreferredHandle((request.getParameter("preferred_handles"))
                            .equals("") ? null : request.getParameter("preferred_handles"));
            ...
            else
            {
                ...
                e.setRequireCertificate((request
                        ...
                        && request.getParameter("require_certificate").equals(
                                "true"));
                    e.form_setPreferredHandle((request.getParameter("preferred_handles"))
                            .equals("") ? null : request.getParameter("preferred_handles"));
