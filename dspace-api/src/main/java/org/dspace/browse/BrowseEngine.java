...
//            BrowseInfo browseInfo = new BrowseInfo(results, position, total, offset);
            ...
            // alteracao introduzida para visualização de valor da autoridade
            browseInfo.setValue(scope.getFilterValue());
        ...
        throws BrowseException
    {
        ...
        try
        {
            ...
            log.info("browseByValue - dao.setTable:" + browseIndex.getDistinctTableName());
