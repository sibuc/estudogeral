    ...
    public int doStartTag() throws JspException
    {
        ...
        try
        {
            ...
            for (int i = 0; i < communities.length; i++)
            {
                ...
                if (ConfigurationManager.getBooleanProperty("stats.reports.community.taglist"))
                	out.print(ReportLinkManager.generateLink(pageContext, (HttpServletRequest) pageContext.getRequest(), communities[i]));
