...
<script type="text/javascript">
   ...
   jQuery(document).ready(function(){
        jQuery('.communityCollections').hide();
        jQuery('.lnkToggleCommunityCollections').click(function(){
...
<%!
    		...
    		Map collectionMap, Map subcommunityMap) throws ItemCountException, IOException, SQLException
    {
		...
		String string = c.getHandle();
		String[] parts = string.split("/");
		String part2 = parts[1];
		
		
        out.println( "<li class=\"disable\">" );
        ...
        out.println( "<div class=\"disable\"><h4 class=\"disable\"><a style=\"top: 2.9px;\" class=\"glyphicon lnkToggleCommunityCollections\" href=\"#communityCollections"+part2+"\">&#xe114</a><a href=\"" + request.getContextPath() + "/handle/" 
        ...
        {
            out.println("<ul id=\"communityCollections"+part2+"\" class=\"communityCollections\" style=\"display: none;\">");
            for (int j = 0; j < cols.length; j++)
            {
                ...
                out.println("<div class=\"disable\"><h4 class=\"disable\"><a href=\"" + request.getContextPath() + "/handle/" + cols[j].getHandle() + "\">" + cols[j].getMetadata("name") +"</a>");
				if(ConfigurationManager.getBooleanProperty("webui.strengths.show"))
                {
...
{
%>
<div class="panel panel-primary panel-list" style="padding-left:15px">
    <ul class="media-list">
<%
