                ...
                case Constants.ITEM:
                    ...
                    else
                    {
						new DSpace().getEventService().fireEvent(
								new UsageEvent(UsageEvent.Action.SEARCH,
										request, context,
										resultsItems[itemCount], request
												.getParameter("query")));
                    }
                ...
                case Constants.COLLECTION:
                    ...
                    else
                    {
						new DSpace().getEventService().fireEvent(
								new UsageEvent(UsageEvent.Action.SEARCH,
										request, context,
										resultsCollections[collCount], request
												.getParameter("query")));
                    }
                ...
                case Constants.COMMUNITY:
                    ...
                    else
                    {
						new DSpace().getEventService().fireEvent(
								new UsageEvent(UsageEvent.Action.SEARCH,
										request, context,
										resultsCommunities[commCount], request
												.getParameter("query")));
                    }
...
//			new DSpace().getEventService().fireEvent(
//					new UsageEvent(UsageEvent.Action.SEARCH, request, context,
//							new Site(), request.getParameter("query")));
