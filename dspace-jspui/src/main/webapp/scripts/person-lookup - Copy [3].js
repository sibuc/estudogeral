...
//									'<button class="close" data-dismiss="modal" type="button">'+
    ...
    var lessButton = '<button id="lookup-less-button" class="btn btn-default" name="morebt">show less</button>';
        ...
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
            ...
            $row.click(function() {
                ...
                if(aData['insolr']!="false"){
				   ...
				   var discoverLink = "http://193.137.200.189:8080/jspui/simple-search?location=&query=&filtername=author&filtertype=authority&filterquery=" + aData['insolr'].trim() + "				   &rpp=10&sort_by=score&order=desc";
