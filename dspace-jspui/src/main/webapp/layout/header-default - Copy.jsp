...
<div class="container banner">
	<div class="row">		
			<!--<div class="col-md-8 brand">		
				<a href="/"><img style="width:152%" alt="sibuc banner" src="<%= request.getContextPath() %>/image/bannerTop.jpg" class="Ximg-responsive"></a>		
        	</div>		-->
	...
	<form class="navbar-form navbar-right" action="/simple-search" method="get">
	    <div class="form-group">
          <input type="text" size="25" id="tequery" name="query" placeholder="Search&nbsp;Repository" class="form-control">
        </div>
