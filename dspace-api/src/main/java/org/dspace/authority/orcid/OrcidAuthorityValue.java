...
public class OrcidAuthorityValue extends PersonAuthorityValue {
    ...
    public SolrInputDocument getSolrInputDocument() {
        ...
        if (StringUtils.isNotBlank(getOrcid_id())) {
            ...
            log.info("SolrInputDocument:"+ doc.getField("orcid_id"));
        }
    ...
    public static OrcidAuthorityValue create(Bio bio) {
        ...
        log.info("OrcidAuthorityValue:create(Bio bio): id" + authority.getId());
        log.info("OrcidAuthorityValue:create(Bio bio): ORCid" + authority.getOrcid_id());
