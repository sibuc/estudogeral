...
<!--<button data-toggle="collapse" data-target="#coll"><fmt:message key="jsp.search.facet.refine" /></button>
<div id="coll" class="col-md-<%= discovery_panel_cols %> collapse">
-->

<div id="side-facet" class="col-md-<%= discovery_panel_cols %>">
