...
<%
	...
	if (bi.hasValue())
	{
   	...
   	if (value!=null)
	{
		valueString = valueString + "&amp;" + argument + "=" + URLEncoder.encode(value, "UTF-8");
...
<!--		<fmt:message key="browse.full.header"><fmt:param value="<%= scope %>"/></fmt:message> <fmt:message key="<%= typeKey %>"/> <%= value_name %> -->
	</h2>
