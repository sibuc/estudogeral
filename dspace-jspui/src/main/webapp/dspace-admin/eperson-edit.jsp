...
<%
    ...
    String preferred_handles = eperson.form_getPreferredHandle();
    ...
    <form method="post" action="">
        ...
        <div class="row">
           <%-- <td>PreferredHandles:</td> --%>
            <label class="col-md-2" for="tpreferreg_handles"><fmt:message key="jsp.dspace-admin.eperson-edit.preferredhandles"/></label>
            <div class="col-md-6">
               <input name="preferred_handles" id="tpreferred_handles" size="24" value="<%=preferred_handles == null ? "" : Utils.addEntities(preferred_handles) %>"/>
           </div> 
       </div> 
       <div class="row">          
